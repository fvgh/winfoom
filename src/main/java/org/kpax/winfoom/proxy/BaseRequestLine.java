...
public final class BaseRequestLine implements Serializable {
    ...
    public BaseRequestLine(final HttpRequest request) throws URISyntaxException {
        super();
    ...
    public BaseRequestLine(final String method,
                       final URI uri,
